...
namespace StoresManagement.Controllers
{
    public class BranchesController : Controller
    {
        ...
        {
            ViewBag.Id = new SelectList(db.Contacts, "Id", "AddressCountry");
        ...
        public ActionResult Create([Bind(Include = "EntityId,Identification,Name,ContactId")] Branch branch)
        {
            ...
            ViewBag.Id = new SelectList(db.Contacts, "Id", "AddressCountry", branch.Id);
